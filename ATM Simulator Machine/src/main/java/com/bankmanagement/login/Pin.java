...
//        add(l4);
        ...
        l1.setBounds(280,100,800,35);
        add(l1);
        
        l2.setBounds(180,190,150,35);
        add(l2);
        
        l3.setBounds(180,250,200,35);
        add(l3);
        
        t1.setBounds(350,190,180,25);
        add(t1);
        
        t2.setBounds(350,250,180,25);
        add(t2);
        
        b1.setBounds(390,330,150,35);
        add(b1);
        
        b2.setBounds(390,390,150,35);
        add(b2);
